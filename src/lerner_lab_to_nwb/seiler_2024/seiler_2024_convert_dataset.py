...
def dataset_to_nwb(
    ...
    for experimental_group in experimental_groups:
        ...
        for subject_dir in tqdm(subject_dirs):
            ...
            header_variables = get_header_variables(subject_dir, subject_id, raw_file_to_info)
            start_dates, start_times, msns, file_paths, subjects, box_numbers = header_variables
            find_medpc_sessions_that_match_missing_csv_sessions(
                start_variable,
                raw_file_to_info,
                subject_dir,
                csv_session_dates,
            ...
            convert_sessions_from_info(
                ...
                missing_msn_errors=missing_msn_errors,
...
def find_medpc_sessions_that_match_missing_csv_sessions(
    start_variable,
    raw_file_to_info,
    subject_dir,
    csv_session_dates,
...
def get_header_variables(subject_dir, subject_id, raw_file_to_info):
...
def convert_sessions_from_info(
    start_dates,
    start_times,
    msns,
    file_paths,
